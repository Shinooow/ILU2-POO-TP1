...
public class Scenario {
	...
	/*
	 * 	Le vendeur Bonemine quitte son étal, il a vendu 20 parmi fleurs.

		Le marché du village "le village des irréductibles" possède plusieurs étals :
		L'étal de Assurancetourix est garni de 5 lyres
		L'étal de Obélix est garni de 2 menhirs
		L'étal de Panoramix est garni de 10 fleurs
